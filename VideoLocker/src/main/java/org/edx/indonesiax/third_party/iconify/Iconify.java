...
import static org.edx.indonesiax.third_party.iconify.Utils.replaceIcons;
...
public final class Iconify {
    ...
    private static final String TTF_FILE = "fonts/fontawesome-webfont-4.3.0.ttf";
    ...
    public static final Typeface getTypeface(Context context) {
        if (typeface == null) {
            try {
                //NOTE -  changed to load assets from assets folder.
                //original code load font file from within its project
