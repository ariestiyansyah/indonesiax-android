package org.edx.indonesiax.third_party.view;
 ...
 *
 * https://github.com/beworker/pinned-section-listview/blob/master/library/src/com/hb/views/PinnedSectionListView.java
 */
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if ( adapter != null) {
            if (!(adapter instanceof PinnedSectionListAdapter)) {
                logger.warn("Does your adapter implement PinnedSectionListAdapter?");
                return;
            }
            if (adapter.getViewTypeCount() < 2) {
                logger.warn("Does your adapter handle at least two types" +
