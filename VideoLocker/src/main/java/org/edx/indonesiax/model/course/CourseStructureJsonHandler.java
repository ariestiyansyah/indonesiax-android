...
//            .registerSubtype(VideoData.class);
    ...
    class BlockListDeserializer implements JsonDeserializer<BlockList>
    {
        @Override
        public BlockList deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException
        {
    ...
    class BlockTypeDeserializer implements JsonDeserializer<BlockType>
    {
        @Override
